...
question		db 		"Choose a single-digit number to multiply by 6 or enter 'q' to quit: ",0
...
prompt:	  
	  ...
	  ; display statement
	  write STDOUT, statement, statement_len
	  
	  ; display chosen number
	  write STDOUT, number, number_len
	  ...
	  ; multiply inputted number and 6
